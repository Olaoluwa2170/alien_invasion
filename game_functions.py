...
def fire_bullet(ai_settings, screen, ship, bullets):
        ...
        # create new bullet and add it to the bullret group
...
def check_bullet_collisions(ai_settings, screen, stats, sb, ship, aliens, bullets):
        ...
        # Removes any bullets and alien that have collided
        collisions = pygame.sprite.groupcollide(bullets, aliens, True, True)

        if len(aliens)==0:
            # Destroy the bullets and create new fleet
            bullets.empty()
...
def ship_hit(ai_settings, stats, screen, sb, ship, aliens, bullets):
    ...
    if stats.ships_left > 0:
        ...
        # Empty the lidt of bullets and ships
        aliens.empty()
        bullets.empty()
...
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets, play_button, info):
    """update image and flip to the other screen"""
...
def get_number_aliens_x(ai_settings, alien_width):
    ...
    numbers_of_alien_x = int(available_space_x/(2*alien_width))
    return numbers_of_alien_x

def get_number_rows(ai_settings, ship_height, alien_height):
    """Determine the number of rows of aliens that fit on the screen."""
    available_space_y = (ai_settings.screen_height - 
    (3*alien_height) - ship_height)  
    numbers_of_rows = int(available_space_y/(2*alien_height))
